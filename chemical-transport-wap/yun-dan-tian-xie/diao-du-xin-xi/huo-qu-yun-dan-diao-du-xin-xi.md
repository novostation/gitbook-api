...
```
/app/dyBill/getBillBsEmployeeAndBsVehicle/{id}
```
...
```
/app/dyBill/getBillBsEmployeeAndBsVehicle/18754
```
...
```
{
    ...
    "data": {
        "controlMes": {
            ...
            "receptdate": "2017-01-01 00:00:00",
            "guacarmes": {
                "vehicleId": 2000848,
                "companyId": 871835,
                "numberPlate": "粤AB255挂-黄-黄",
                "numberPlateColor": "黄",
                "vehicleType": "重型货车",
